  ...
  return (
    <div className='text-container'>
      <ul className='offer'>
        ...
        <li>
          <h3>Manikyr (vanliga) </h3> - <span className='price'>350kr</span>{' '}
        </li>
        <li>
          <h3>Manikyr med gellack</h3> - <span className='price'>450kr</span>{' '}
        </li>
        <li>
          <h3>Nagelförlängning Nytt Set med fransk, ombre eller glitter</h3> -{' '}
          <span className='price'>780kr</span>
        </li>
        <li>
          <h3>Nagelförlängning Nytt Set med gellack</h3> -{' '}
          <span className='price'>720kr</span>
        </li>
        <li>
          <h3>Nagelförstärkning med gellack</h3> -{' '}
          <span className='price'>600kr</span>
        </li>
        <br />
        ...
        <li>
          ...
          <span className='price'>660kr</span>
        </li>
        <li>
          <h3>Nagelförstärkning med gellack (Påfyllning)</h3> -{' '}
          <span className='price'>540kr</span>
        </li>
        <br />
        ...
        <li>
          ...
          <span className='price'>650kr</span>
        </li>
        <li>
          <h3>Volymfransar Nytt Set (2-3D)</h3> -{' '}
          <span className='price'>750kr</span>
        </li>
        <li>
          <h3>Volymfransar Nytt Set (4-6D)</h3> -{' '}
          <span className='price'>850kr</span>
        </li>
        <br />
        ...
        <li>
          ...
          <span className='price'>700kr</span>
        </li>
        <li>
          <h3>Volymfransar Påfyllning (4-6D)</h3> -{' '}
          <span className='price'>800kr</span>
        </li>
        <br />
        <h2>Ögonbryn</h2>
        ...
        <li>
          ...
          <span className='price'>250kr</span>
        </li>
        <li>
          <h3>Henna brow med ögonbrynsgeometri</h3> -{' '}
          <span className='price'>400kr</span>
        </li>
        <br />
        <h2>Borttagning</h2>

        <li>
          <h3>Borttagning fransar</h3> - <span className='price'>300kr</span>
        </li>
        <li>
          <h3>Bortagning gel med vanlig manikyr</h3> -{' '}
          <span className='price'>390kr</span>
        </li>
      </ul>
      {/* <ul className='offer'>
        <li>
